...
function AddNewInterview() {
  ...
  return (
    <div>
      <div
        className="p-10 border rounded-lg bg-[#4642d2] hover:scale-105 hover:shadow-md cursor-pointer transition-all"
        onClick={() => setOpenDialog(true)}
      >
        <h1 className="font-bold text-lg text-white text-center">+ Add New</h1>
      </div>
      <Dialog open={openDialog} onOpenChange={setOpenDialog}>
        <DialogContent className="max-w-2xl bg-white rounded-lg">
          <DialogHeader>
            <DialogTitle className="font-bold text-2xl text-[#4642d2]">
          ...
          <DialogDescription>
            <form onSubmit={onSubmit}>
              <div>
                ...
                <div className="mt-7 my-3">
                  ...
                  <Input
                    ...
                    className="border-[#4642d2] focus:ring-[#4642d2] focus:border-[#4642d2]"
                  />
                </div>
                <div className="my-3">
                  <label className="text-gray-700">Job Description/Tech Stack (In short)</label>
                  <Textarea
              ...
              <div className="flex gap-5 justify-end">
                ...
                <Button type="submit" disabled={loading} className="bg-[#4642d2] text-white hover:bg-[#3731b3]">
                  {loading ? (
                    <>
